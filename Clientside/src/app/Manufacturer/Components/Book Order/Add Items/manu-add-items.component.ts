...
@Component({
  selector: 'app-manu-add-items',
  templateUrl: './manu-add-items.component.html',
  styles: ['./manu-add-items.component.css']
})
export class ManufacturerAddItemsComponent implements OnInit {
  productList = ELEMENT_DATA;
  isValid: boolean = true;
  data1: ManufacturerSubOrder = new ManufacturerSubOrder;

  constructor(
    @Inject(MAT_DIALOG_DATA) public currentSubOrder: ManufacturerSubOrder,
    public dialogRef: MatDialogRef<ManufacturerAddItemsComponent>) {
