...
import { PharmacistShowProductsComponent } from '../Show Products/pharm-show-products.component';
...
@Component({
  ...
  templateUrl: './pharm-view-order.component.html',
...
export class PharmacistViewOrderComponent implements OnInit {
  ...
  commonArray: PharmacistCompleteOrder[] = [];
