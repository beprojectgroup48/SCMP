...
const orderpharmacistSchema = mongoose.Schema({
    orderId:{
        type:String,
        required:true
    },
    ...
    collection: 'orderpharmacist'
});
const ordersPharmacist = module.exports = mongoose.model('ordersPharmacist', orderpharmacistSchema);


module.exports.getOrderById = function(id, callback){
    ordersPharmacist.findById(id, callback);
}
